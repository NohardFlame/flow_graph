"""Fixtures for observability tests. Reuses DB/storage/orchestration pattern from workers."""
...
def orchestration_context(
    ...
    """Seed document/version/run, build orchestrator. For event/metrics tests."""
